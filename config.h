...
/* Name of package */
#define PACKAGE "zoodisr"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "jinoos@gmail.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "zoodisr"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "zoodisr 0.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zoodisr"
...
#define ZR_VERSION_MAJOR 0

/* Define the minor version number */
#define ZR_VERSION_MINOR 1

/* Define the patch version number */
#define ZR_VERSION_PATCH 0

/* Define the version string */
#define ZR_VERSION_STRING "0.1.0"
